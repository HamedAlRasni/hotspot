var k="الاحد الاثنين الثلاثاء الاربعاء الخميس الجمعة السبت".split(" ");function l(a){var b,g=null!=(b=a.getAttribute("hot-img-path"))?b:"1.jpg";a.style.textAlign="center";var c=new Image;c.src="adv_img/"+g;c.classList.add("adv-img");c.complete?a.innerHTML=c.outerHTML:(c.onload=function(){a.innerHTML=c.outerHTML},c.onerror=function(){document.querySelector(".logo").style.paddingTop="50px";var d=document.querySelector(".section");d.hasAttribute("enable-hot-marquee")&&(d.style.display="block")})}
